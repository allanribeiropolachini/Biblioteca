...
public class Biblioteca {
        ...
        try {
            ...
            while (inputStream.hasNext()) {
                ...
                while (!campo[i].equals("fim")) {
                    ...
                    System.out.println(campo[i + 2]);
                    System.out.println(campo[i + 3]);
                    System.out.println(campo[i + 4]);
                    System.out.println(campo[i + 5]);
                    System.out.println(campo[i + 6]);
                    System.out.println(campo[i + 7]);
                    //if (ano - Integer.parseInt(campo[i + 2]) >= 0) {
                    //if (mes - Integer.parseInt(campo[i + 1]) >= 0) {
                    //if (dia - Integer.parseInt(campo[i]) >= 0) {
    ...
    /*void renovarLivro() {
     ...
     usuarios.get(indexUsuario).renovarLivro(str);
     }
     }*/
